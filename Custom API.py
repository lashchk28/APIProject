...
#URL1 = ("http://ip-api.com/json/fields=status,message,regionName,city,lat,lon,isp")
...
#URL3 = ("https://pollen.googleapis.com/v1/forecast:lookup?key=AIzaSyBq-V3B0PuvZMPCRgbMGxNSDOwmNXZU5DU&days=1")
