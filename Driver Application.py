...
class IWP(db.Model):
   ...
   PlantInfo = db.Column(db.String, nullable=False)
   def IWP(self):
        return f"IWP(isp = {isp}, city = {city}, regionName = {regionName}, temperature_2m = {temperature_2m}, relative_humidity_2m = {relative_humidity_2m}, precipitation = {precipitation}, snowfall = {snowfall}, DayInfo = {DayInfo}, PollenTypeInfo = {PollenTypeInfo}, PlantInfo = {PlantInfo})"